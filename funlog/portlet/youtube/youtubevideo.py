...
from funlog.portlet.youtube import YoutubeVideoMessageFactory as _


class IYoutubeVideo(IPortletDataProvider):
    """A portlet
    ...
    same.
    """
    videoTitle = schema.TextLine(
        title=_(u"Video title"),
        required=True,
    )
...
class Assignment(base.Assignment):
    ...
    def __init__(self, videoTitle, videoUrl):
...
class Renderer(base.Renderer):
    ...
    render = ViewPageTemplateFile('youtubevideo.pt')
...
class AddForm(base.AddForm):
    ...
    """
    form_fields = form.Fields(IYoutubeVideo)
